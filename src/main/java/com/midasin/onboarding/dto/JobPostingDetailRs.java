...
public record JobPostingDetailRs(Integer jobPostingId, String title, String description, String positionName,
                                 EmploymentType employmentType, String location, String department, String quantity,
